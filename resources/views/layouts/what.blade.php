...
{{--   <div class="timeline-item">
  ...
  <div class="timeline-item">
    ...
    <div class="timeline-content right">
      <h2 class="timeline-content-date">Effective Lessons</h2>
      <p>Courses are designed and taught by staff who have a rich and deep experience of working with students at all levels of study.</p>
    </div>
  </div>
  ...
  <div class="timeline-item">
    ...
    <div class="timeline-content right">
      <h2 class="timeline-content-date">Focus on Details</h2>
      <p>
        Good lesson planning is essential to the process of teaching and learning. Our curriculum is strongly focused on developing the required skills to become a life long learner.
      </p>
    </div>
  </div>
  ...
  <div class="timeline-item">
    ...
    <div class="timeline-content">
      <h2 class="timeline-content-date">Awesome Quizzles</h2>
      <p>It gives all learners opportunity to interact through thought provoking questions that can help every learner grasps the content of a course with ease. It promises to be fun.</p>
    </div>
  </div>
